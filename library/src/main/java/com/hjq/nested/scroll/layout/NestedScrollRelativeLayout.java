 ...
 *    time   : 2023/07/02
 *    desc   : 支持嵌套滚动的 RelativeLayout
 */
public class NestedScrollRelativeLayout extends RelativeLayout implements NestedScrollingChild, NestedScrollingParent {
   ...
   public NestedScrollRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
   ...
   public boolean onTouchEvent(MotionEvent ev) {
      ...
      switch (actionMasked) {
         ...
         case MotionEvent.ACTION_MOVE:
            ...
            if (!mBeingDragged && Math.abs(mLastMotionY - y) > mTouchSlop) {
